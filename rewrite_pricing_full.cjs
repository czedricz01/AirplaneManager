...
const content = fs.readFileSync('src/components/RoutePricingEditView.tsx', 'utf8');

// The file has a duplicate `cls` reference at the bottom inside the `<div className="hidden">` part.
// I will just parse out the full component and write a clean one.
...
fs.writeFileSync('src/components/RoutePricingEditView.tsx', cleanCode);
